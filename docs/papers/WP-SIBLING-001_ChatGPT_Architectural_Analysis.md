...
**DATE:** 2026-01-15
**STATUS:** Logged for Architectural Reference
...
* **Cloud model:**
  ...
  * Best for long-horizon reasoning, summarization, legal/linguistic nuance
* **Local models:**

  * Best for tools, deterministic ops, privacy-sensitive work, resilience
* **Goose:**

  * Keeps the human in the loop
  * Keeps models interchangeable
